...
let globalStorage = {}
console.log("The Extension 'LFS' has started");
let sortFile = vscode.commands.registerCommand('LFS.sortFile',async function () {
let funcName = "sort_file"; let pyVar = "python";
...
context.subscriptions.push(sortFile);
}
